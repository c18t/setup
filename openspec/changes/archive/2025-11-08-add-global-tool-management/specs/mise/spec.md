...
- **THEN** all packages listed in `.default-pnpm-packages` SHALL be
  installed globally via `pnpm install -g`
...
- **THEN** documentation SHALL provide the command to list global packages
...
- **THEN** documentation SHALL provide the command to list installed tools
  in the correct format
